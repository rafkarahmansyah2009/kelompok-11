...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    // Insert data siswa
    $query = "INSERT INTO siswa (nama_siswa, kelas, id_guru, jurusan) VALUES (?, ?, ?, ?)";
    $stmt = $conn->prepare($query);
    $stmt->bind_param("ssis", $nama_siswa, $kelas, $id_guru, $jurusan);
    ...
    <div class="dashboard-container">
        ...
        <div class="main-content">
            ...
            <div class="form-container fade-in">
                <h2 class="form-title">Form Tambah Siswa</h2>
                    ...
                    <div class="form-group">
                        ...
                        <div class="jurusan-options">
                            <?php foreach ($jurusan_options as $code => $jurusan): ?>
                                <div class="jurusan-option" data-jurusan="<?php echo $code; ?>">
